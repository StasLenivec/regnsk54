<template>
  <nav :class="classes" class="navbar">
    <div :class="containerClasses">
      ...
      >
        <!-- <ul
          class="d-flex align-items-center justify-content-around text-center w-50 m-0 p-0"
        >
          <li class="px-2 text-uppercase">услуги</li>
          <li class="px-2 text-uppercase">купить документ</li>
          <li class="px-2 text-uppercase">о нас</li>
        </ul> -->
